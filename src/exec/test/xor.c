...
int main()
{
    ...
    int start = kv_size(code);
        ...
        // big & big -> int
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_XOR }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_INT, .value2.s = 2 }));
        // int & big -> big
        ...
        // big & big -> big
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_XOR }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_BIG, .value2.s = "27670116110564327424" }));
