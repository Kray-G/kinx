...
int test(void)
{
    ...
    int start = kv_size(code);
        ...
        // und -> 1
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INC }));
        ...
        // und -> 1
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INCP }));
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(ctx, __FILE__), .line = __LINE__, .value1.i = KX_INT_T, .value2.i = 1 }));
        // und -> 1
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INCV, .value1.i = 0, .value2.i = 5 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(ctx, __FILE__), .line = __LINE__, .value1.i = KX_INT_T, .value2.i = 1 }));
        // und -> 1
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INCVP, .value1.i = 0, .value2.i = 6 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(ctx, __FILE__), .line = __LINE__, .value1.i = KX_UND_T }));
        ...
        // int -> int
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(ctx, __FILE__), .line = __LINE__, .value1.i = KX_INT_T, .value2.i = 101 }));
        // int -> big
        ...
        // dbl -> dbl
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(ctx, __FILE__), .line = __LINE__, .value1.i = KX_DBL_T, .value2.d = 102.5 }));
