...
int main()
{
    ...
    int start = kv_size(code);
        ...
        // big -> big
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KX_BIG_T, .value2.i = "-9223372036854775809" }));
        // big -> big
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHI, .value1.i = INT64_MAX }));
        ...
        // dbl -> dbl
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_INC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KX_DBL_T, .value2.d = 102.5 }));
