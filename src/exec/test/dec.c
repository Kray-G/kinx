...
int main()
{
    ...
    int start = kv_size(code);
        ...
        // int -> int
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_DEC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KX_INT_T, .value2.i = 99 }));
        // int -> big
        ...
        // dbl -> dbl
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_DEC }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KX_DBL_T, .value2.d = 100.5 }));
