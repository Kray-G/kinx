...
int main()
{
    ...
    int start = kv_size(code);
        ...
        // -dbl
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_NEG }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KEX_DBL, .value2.d = 0.0 }));
        // -dbl
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHD, .value1.d = 1.0 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_NEG }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KEX_DBL, .value2.d = -1.0 }));
        // -dbl
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHD, .value1.d = -1.0 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_NEG }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KEX_DBL, .value2.d = 1.0 }));
