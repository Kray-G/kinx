...
int main()
{
    ...
    int start = kv_size(code);
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_INT, .value2.i = 10000 }));
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_DBL, .value2.d = 5.5 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHS, .value1.s = "aaaaaa" }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_CSTR, .value2.s = "aaaaaa" }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHF, .addr = 10 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_PUSHVL, .value1.i = 0, .value2.i = 0 }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .value1.i = KEX_INT, .value2.i = 100 }));
