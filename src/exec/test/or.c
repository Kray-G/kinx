...
int main()
{
    ...
    int start = kv_size(code);
        ...
        // dbl & int -> int
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KEX_INT, .value2.i = 31 }));
        // int & dbl -> int
        ...
        // big & big -> big
            ...
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_OR }));
            kv_push(kx_code_t, code, ((kx_code_t){ .op = KX_CHKVAL, .file = const_str(__FILE__), .line = __LINE__, .value1.i = KEX_BIG, .value2.s = "27670116110564327425" }));
        // int & big -> big
