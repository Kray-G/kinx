...
static inline const char *startup_code()
{
    static const char *code =
        "var System:obj = _import('kxsystem');\n"
        "var String:obj = _import('kxstring');\n"
        "var Binary:obj = _import('kxbinary');\n"
        "var Array:obj = _import('kxarray');\n"
        "var Integer:obj = _import('kxinteger');\n"
        "var Double:obj = _import('kxdouble');\n"
