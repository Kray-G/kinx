...
static inline const char *startup_code()
{
    static const char *code =
        "var System, String, Binary, Array, Integer, Double, Math, Regex, File, JSON, SystemTimer, RuntimeException, Fiber, True, False;\n"
        "(_function() {\n"
            ...
            "RuntimeException = _function(msg) { return { _type: 'RuntimeException', _what: msg }; };\n"
            ...
            "if (!System.isInitialized) {\n"
                ...
                "(_function() {\n"
                    "System.try = _function(f) {\n"
                        ...
                        "}\n"
                        "return {\n"
                            "'else': &(expr) => expr.isFunction ? expr() : expr,\n"
                            "'try': System.try,\n"
                            "'retry': &(count, wait) => {\n"
                                "System.sleep(wait);\n"
