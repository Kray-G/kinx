...
cl %CFLAGS% /Fekinx.exe src/parser.c src/lexer.c src/ast_object.c src/ast_display.c src/ast_analyzer.c src/ast_gencode.c src/ir_dump.c src/vector.c src/main.c
